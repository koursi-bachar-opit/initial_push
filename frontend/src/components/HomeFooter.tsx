...
export const HomeFooter: React.FC = () => {
  ...
  return (
    <footer className="relative bg-transparent dark:bg-black/40 pt-20 pb-12 transition-colors duration-500 border-t border-zinc-200 dark:border-white/10">
        ...
        <div className="border-t border-zinc-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="text-sm text-zinc-500 dark:text-zinc-400">
              © {currentYear} SuperVision Remote Servers. All rights reserved.
            </span>
          </div>
