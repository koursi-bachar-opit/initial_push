...
def organization_repository():
    """OrganizationRepository instance fixture"""
...
class TestOrganizationRepository:
    ...
    def test_create_performs_database_operations(self, mock_db, organization_repository):
        ...
        organization_repository.create(mock_db, data)
        
        mock_db.add.assert_called_once()
        mock_db.commit.assert_called_once()
        mock_db.refresh.assert_called_once()

    def test_update_performs_database_operations(self, mock_db, organization_repository, sample_organization):
        ...
        result = organization_repository.update(mock_db, sample_organization, data)
        
        assert result == sample_organization
        mock_db.commit.assert_called_once()
        mock_db.refresh.assert_called_once_with(sample_organization)

    def test_get_returns_organization_when_exists(self, mock_db, organization_repository, sample_organization):
        ...
        result = organization_repository.get(mock_db, org_id)
        
        assert result == sample_organization
        mock_db.query.assert_called_once_with(Organization)
        mock_query.filter_by.assert_called_once_with(id=org_id)

    def test_get_returns_none_when_not_found(self, mock_db, organization_repository):
    ...
    def test_list_for_user_returns_user_organizations(self, mock_db, organization_repository):
        ...
        result = organization_repository.list_for_user(mock_db, user_id)
    ...
    def test_list_for_user_returns_empty_list_when_none_exist(self, mock_db, organization_repository):
    ...
    def test_add_member_performs_database_operations(self, mock_db, organization_repository, sample_membership):
        ...
        result = organization_repository.add_member(mock_db, org_id, user_id, role)
        
        mock_db.add.assert_called_once()
        mock_db.commit.assert_called_once()
        mock_db.refresh.assert_called_once()

    def test_remove_member_performs_database_operations(self, mock_db, organization_repository):
        ...
        organization_repository.remove_member(mock_db, org_id, user_id)
    ...
    def test_change_role_updates_existing_membership(self, mock_db, organization_repository, sample_membership):
        ...
        result = organization_repository.change_role(mock_db, org_id, user_id, new_role)
    ...
    def test_list_members_returns_organization_members(self, mock_db, organization_repository, sample_membership):
        ...
        result = organization_repository.list_members(mock_db, org_id)
        
        assert result == mock_memberships
        mock_db.query.assert_called_once_with(OrganizationMembership)
        mock_query.filter_by.assert_called_once_with(organization_id=org_id)

    def test_list_members_returns_empty_list_when_no_members(self, mock_db, organization_repository):
    ...
    def test_get_membership_returns_membership_when_exists(self, mock_db, organization_repository, sample_membership):
        ...
        result = organization_repository.get_membership(mock_db, org_id, user_id)
        
        assert result == sample_membership
        mock_db.query.assert_called_once_with(OrganizationMembership)
        mock_query.filter_by.assert_called_once_with(organization_id=org_id, user_id=user_id)

    def test_get_membership_returns_none_when_not_found(self, mock_db, organization_repository):
